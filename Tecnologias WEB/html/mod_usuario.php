...
<html>
  <head>
	...
	<!--<span style="float:left">Usted est&aacute aqu&iacute: <a href="main.php">Inicio</a> > <a href="products.php">Gesti&oacuten de productos</a> >  Editar producto</span><br/>-->
			...
			<legend>Visualizar mis datos</legend>
			<center>
				<form action="mod_usuario2.php">
				<table>
					<tr><td>
					<label>Mail:</label>
					</td>
					...
					<td>
					<input type="text" id="passwd" name="passwd" value="<?php echo $passwd; ?>" disabled/>
					</td></tr>
					<tr><td>
					<label>Nombre:</label>
					</td><td>
					...
					<input type="text" id="tfn" name="tfn" value="<?php echo $tfn; ?>" disabled/>
					</td></tr>
					<tr><td>
					...
					<input type="text" id="cp" name="cp" value="<?php echo $cp; ?>" disabled/>
					</td></tr>
					<tr><td>
					<label>Poblaci&oacuten: </label>
					</td><td>
					<input type="text" id="poblacion" name="poblacion" value="<?php echo $poblacion; ?>" disabled/>
					</td></tr>
					<tr><td>
					<label>Pais:</label>
					</td><td>
					<input type="text" id="pais" name="pais" value="<?php echo $pais; ?>" disabled/>
					</td></tr>
					<tr><td>
					...
					<tr><td colspan="2">
					<center><input type="submit" value="Modificar mis datos" /> 
					</form>
