...
<html>
  <head>
	...
	<body>
	<span style="float:left">Usted est&aacute aqu&iacute: <a href="main.php">Inicio</a> > <a href="clients.php">Gesti&oacuten de clientes</a> > <a href="ofrecidos.php">Productos favoritos de clientes</a></span><br/>
		<section id="centralSection">
			...
			<legend>Gestionar Clientes</legend>
					...
					// sending query
					$result = mysql_query("SELECT * FROM articulosfavsclientes");
					if (!$result) {
